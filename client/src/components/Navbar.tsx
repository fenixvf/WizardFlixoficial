    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-black/80 backdrop-blur-md">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <span className="font-rune text-2xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-300 tracking-wider group-hover:to-purple-200 transition-all">
            Wizard Flix
          </span>
        </Link>
